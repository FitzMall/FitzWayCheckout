...
namespace FitzCheckout.DAL
{
    ...
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["Checklist"].ConnectionString;
        ...
        /// <param name="mycontstring"></param>
        /// <returns></returns>
        public static List<T> SqlWithParams<T>(string sql, dynamic parms, string mycontstring)
        {
